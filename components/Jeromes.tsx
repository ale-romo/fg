...
const Jeromes = () => {
  return <section className="text-left text-xl w-full max-w-full jeromes flex justify-center items-stretch py-36">
    <div className="flex-1" style={{ backgroundImage: 'url(/jeromes/left.jpg)'}}></div>
    <div className="py-32 px-40 flex flex-col items-left flex-co -my-20" style={{ background: "#ECE9E4", maxWidth: "1120px" }}>

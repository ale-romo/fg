...
const Article = ({ params: { aid }}: Params) => {
  ...
  return <>
    <section className='flex flex-col text-center text-lg items-center p-8 pb-0 md:pb-0 md:p-20 '>
      ...
      <h4>{article.desc}</h4>
      <p className="uppercase font-semibold mb-6 mt-2" style={{ fontSize: "9px" }}>August 2023</p>
      <Image src={article.img} height="577" width="954" alt={article.title} className="  h-auto pb-10"/>
